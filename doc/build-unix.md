UNIX BUILD NOTES
====================
Some notes on how to build Vzuh in Unix.
...
memory available when compiling Vzuh Core. With 512MB of memory or less
...
If you want to build Vzuh-Qt, make sure that the required packages for Qt development
...
# Configure Vzuh Core to use our own-built instance of BDB
cd $Vzuh_ROOT
...
Security
--------
To help make your Vzuh installation more secure by making certain attacks impossible to
