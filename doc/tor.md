...
It is possible to run Vzuh as a Tor hidden service, and connect to such services.
...
Run Vzuh behind a Tor proxy
----------------------------------

The first step is running Vzuh behind a Tor proxy. This will already make all
