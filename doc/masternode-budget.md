...
Vzuh now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ Vzuh, _12_ times over the course of a year totaling _24000_ Vzuh.
...
When block `1000000` is reached you'll receive a payment for `1200` Vzuh.
 ...
 * vote-many          - Vote on a Vzuh initiative
 * vote-alias         - Vote on a Vzuh initiative
 * vote               - Vote on a Vzuh initiative/budget
