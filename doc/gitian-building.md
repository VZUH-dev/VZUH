...
*Setup instructions for a gitian build of Vzuh using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Vzuh
...
- [Building Vzuh](#building-digiwage)
...
To build Vzuh (for Linux, OSX and Windows) just follow the steps under 'perform
