Vzuh Core version 2.3.1 is now available from:
...
Vzuh Core is extensively tested on multiple operating systems using
...
Vzuh Core should also work on most other Unix-like systems but is not
...
[
  {
    ...
    "PaymentAddress": "xxxx",     (string) Vzuh address of payment
