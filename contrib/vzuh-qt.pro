...
RESOURCES += src/qt/vzuh.qrc src/qt/vzuh_locale.qrc

TRANSLATIONS += src/qt/locale/vzuh_bg.ts \
                src/qt/locale/vzuh_de.ts \
                src/qt/locale/vzuh_en.ts \
                src/qt/locale/vzuh_es.ts \
                src/qt/locale/vzuh_fi.ts \
                src/qt/locale/vzuh_fr.ts \
                src/qt/locale/vzuh_it.ts \
                src/qt/locale/vzuh_ja.ts \
                src/qt/locale/vzuh_pl.ts \
                src/qt/locale/vzuh_pt.ts \
                src/qt/locale/vzuh_ru.ts \
                src/qt/locale/vzuh_sk.ts \
                src/qt/locale/vzuh_sv.ts \
                src/qt/locale/vzuh_vi.ts \
                src/qt/locale/vzuh_zh_CN.ts \
                src/qt/locale/vzuh_zh_TW.ts
