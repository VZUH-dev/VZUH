...
#if defined(NDEBUG)
#error "Vzuh cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Vzuh Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	int64_t nSubsidy;
	//int64_t nMasternodeColleteralLimxDev = Params().MasternodeColleteralLimxDev1000();
    ...
    if( nHeight >= 1 && nHeight <= 20160 ) {
		...
		int nMasternodeColleteralLimxDev = Params().MasternodeColleteralLimxDev1000();
	} else if (nHeight >= 43201 && nHeight < 129600) {
        nSubsidy = 1 * COIN;
    } else if (nHeight >= 100000) {
		int nMasternodeColleteralLimxDev = Params().MasternodeColleteralLimxDev5000();
	} else if (nHeight >= 129601 && nHeight < 259200) {
        nSubsidy = 1.2 * COIN;
    } else if (nHeight >= 259201 && nHeight < 518400) {
        nSubsidy = 1.5 * COIN;
    } else if (nHeight >= 518401 && nHeight < 777600) {
        nSubsidy = 1.7 * COIN;
    } else if (nHeight >= 777601 && nHeight < 1036800) {
        nSubsidy = 1.8 * COIN;
    } else if (nHeight >= 1036801 && nHeight < 1555200) {
        nSubsidy = 1.9 * COIN;
    } else if (nHeight >= 1555201) {
        nSubsidy = 2 * COIN;
    } else {
        nSubsidy = 2 * COIN;
    }
