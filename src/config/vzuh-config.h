/* src/config/vzuh-config.h.  Generated from vzuh-config.h.in by configure.  */
/* src/config/vzuh-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef VZUH_CONFIG_H

#define VZUH_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://vzuh.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Vzuh Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Vzuh Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "vzuh"
