...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Vzuh Core vzuh-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  vzuh-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded vzuh transaction") + "\n" +
                               "  vzuh-tx [options] -create [commands]   " + _("Create hex-encoded vzuh transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded vzuh transaction
