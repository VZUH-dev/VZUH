...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* VZUH features */
        {"vzuh", "masternode", &masternode, true, true, false},
        {"vzuh", "masternodelist", &masternodelist, true, true, false},
        {"vzuh", "mnbudget", &mnbudget, true, true, false},
        {"vzuh", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"vzuh", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"vzuh", "mnsync", &mnsync, true, true, false},
        {"vzuh", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"vzuh", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use vzuhd, or the -server option to vzuh-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> vzuh-cli " + methodname + " " + args + "\n";
}
