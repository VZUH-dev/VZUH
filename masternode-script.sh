...
CONFIG_FILE='vzuh.conf'
CONFIGFOLDER='/root/.vzuh'
COIN_DAEMON='/usr/local/bin/vzuhd'
COIN_CLI='/usr/local/bin/vzuh-cli'
COIN_REPO='https://github.com/VZUH-dev/VZUH/releases/download/1.1.0.0-Unix/vzuh-1.1.0-x86_64-linux-gnu.tar.gz'
COIN_NAME='vzuh'
COIN_PORT=25000
